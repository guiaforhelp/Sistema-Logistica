                ...
                <Select value={idSelecionado} onValueChange={setIdSelecionado}>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            value={dadosOperacao.descTrabalho ?? ''}
                            onChange={(e) => setDadosOperacao({ ...dadosOperacao, descTrabalho: e.target.value })}
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full p-3 border border-gray-300 rounded-md resize-none"
                            rows="3"
                            value={dadosOperacao.observacoes ?? ''}
                            onChange={(e) => setDadosOperacao({ ...dadosOperacao, observacoes: e.target.value })}
